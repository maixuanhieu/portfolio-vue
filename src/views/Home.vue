  ...
  >
    ...
    <v-container fluid>
      <v-row>
        ...
        <v-col cols="6">
          <h5 class="red--text text-darken-4 top">Hello I'm XuanHieu</h5>
          <h1 class="white--text">Frontend Developer</h1>
          <p class="grey--text">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. <br />
            Earum dolorem velit, eos a tempore cumque eius labore commodi?
            Temporibus animi totam aspernatur. <br />
            A architecto hic dolore nemo laborum ex velit!
          </p>
              ...
              <v-row>
                <v-col cols="7">
                  ...
                  <p class="grey--text">
                    ...
                    pariatur in dignissimos voluptas aspernatur adipisci, omnis
                    necessitatibus consectetur rerum non quis amet suscipit
                    ratione voluptatibus. <br />
                    In, modi provident? Quasi, omnis.
                  </p>
                </v-col>
...
.first {
  width: 100%;
  height: 610px;
  background: linear-gradient(to right, #181818, #181818 50%, #111111 50%);
  text-align: center;
  padding: 2rem 2rem;
}
